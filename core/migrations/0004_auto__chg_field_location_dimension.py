...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.dimension'
        db.alter_column(u'core_location', 'dimension_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['dimension.Dimension']))

    def backwards(self, orm):

        # Changing field 'Location.dimension'
        db.alter_column(u'core_location', 'dimension_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['dimension.Dimension']))
    ...
    models = {
        ...
        u'core.dimensionpath': {
            'Meta': {'object_name': 'DimensionPath'},
            'dimension': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['dimension.Dimension']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.location': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dimension': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'locations'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['dimension.Dimension']"}),
            'dimension_tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['dimension.Dimension']", 'null': 'True', 'through': u"orm['core.DimensionPath']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
