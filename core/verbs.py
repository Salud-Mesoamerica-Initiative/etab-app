...
class DimensionVerb(StaffVerb):
    display_name = "Create Dimension"
    view_name = 'dimension:index'
...
class SiteRoot(Noun):
    ...
    '''
    verb_classes = [SiteLoginVerb, LocationListStreamVerb, LocationListVerb,
                    LocationListVisualizeVerb, ScoreListVerb, IndicatorListVerb, EntriesFilterVerb,
                    LocationCreateVerb, IndicatorCreateVerb, SiteUserCreateVerb, UserListVerb,
                    DimensionVerb]
...
class CoreUser(Noun):
    ...
    '''
    verb_classes = [UserListVerb, UserDetailVerb, UserUpdateVerb, ResetPasswordVerb,
                    UserDeactivateVerb]
    id = -1
